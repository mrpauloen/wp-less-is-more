...
?>
      ...
      <a href="<?php the_permalink(); ?>" rel="<?php esc_attr_e( 'bookmark', 'wp-less-is-more' ); ?>" title="<?php esc_attr_e( 'Permanent Link to:', 'wp-less-is-more' ); ?>&nbsp;<?php the_title_attribute(); ?>" class="btn btn-default" role="button"> <?php _e( 'Read more...', 'wp-less-is-more' ); ?></a>
